...
namespace fusion {
  ...
  MSKliinfiteme SolverInfo::liinfsyms[] = { MSK_LIINF_BI_CLEAN_DUAL_DEG_ITER,MSK_LIINF_BI_CLEAN_DUAL_ITER,MSK_LIINF_BI_CLEAN_PRIMAL_DEG_ITER,MSK_LIINF_BI_CLEAN_PRIMAL_ITER,MSK_LIINF_BI_DUAL_ITER,MSK_LIINF_BI_PRIMAL_ITER,MSK_LIINF_INTPNT_FACTOR_NUM_NZ,MSK_LIINF_MIO_INTPNT_ITER,MSK_LIINF_MIO_PRESOLVED_ANZ,MSK_LIINF_MIO_SIM_MAXITER_SETBACKS,MSK_LIINF_MIO_SIMPLEX_ITER,MSK_LIINF_RD_NUMANZ,MSK_LIINF_RD_NUMQNZ };
