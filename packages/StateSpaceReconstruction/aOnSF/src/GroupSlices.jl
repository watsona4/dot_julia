# This file is from github user mcaabbot's update to the GroupSlices.jl package
# for julia 0.7, at https://github.com/mcabbott/GroupSlices.jl (MIT licensed).
# Development for the GroupSlices.jl package has stopped, so this is included
# here to allow transitioning the package to Julia 1.0.


@reexport module GroupSlices
