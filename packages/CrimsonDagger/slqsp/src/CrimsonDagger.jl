# borrowed from Dagger.jl's src/scheduler.jl

module CrimsonDagger

using Distributed
import MemPool: DRef

import Dagger: Context, Thunk, Chunk, OSProc
import Dagger: order, free!, dependents, noffspring, istask, inputs, affinity
import Dagger: tochunk, @dbg, @logmsg, timespan_start, timespan_end, unrelease, procs
import Dagger: PLUGIN_CONFIGS
...
function __init__()
    PLUGIN_CONFIGS[:scheduler] = "CrimsonDagger"
end
