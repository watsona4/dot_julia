...
# installed.
TCL_PREFIX='/home/ec2-user/.julia/conda/3'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/ec2-user/.julia/conda/3'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -I/home/ec2-user/.julia/conda/3/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1559570614217/work=/usr/local/src/conda/tk-8.6.9 -fdebug-prefix-map=/home/ec2-user/.julia/conda/3=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -I/home/ec2-user/.julia/conda/3'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/ec2-user/.julia/conda/3/lib -Wl,-rpath-link,/home/ec2-user/.julia/conda/3/lib -L/home/ec2-user/.julia/conda/3/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/ec2-user/.julia/conda/3/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/ec2-user/.julia/conda/3/include'
...
TCL_PACKAGE_PATH='/home/ec2-user/.julia/conda/3/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/ec2-user/.julia/conda/3/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/home/ec2-user/.julia/conda/3/lib/libtclstub8.6.a'
